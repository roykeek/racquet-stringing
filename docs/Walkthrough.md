...
* The stringer visits the website URL and clicks **"כניסת שזרים" (Stringer Login)**.
...
* Any logged-in stringer can navigate to the Work Management section and click **"Add Stringer"**.
